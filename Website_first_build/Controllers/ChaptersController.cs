...
namespace Website_first_build.Controllers
{
    public class ChaptersController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ID,BookID,ChapterNumber")] Chapter chapter)
        {
            ...
            ViewBag.BookID = new SelectList(db.Books, "ID", "BookName", chapter.BookID);
            return View(chapter);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,BookID,ChapterNumber")] Chapter chapter)
        {
            if (ModelState.IsValid)
            {
